...
class OkHttpTransportFactory @Inject constructor() : TransportFactory {
    ...
    private companion object {
         ...
         * sixty seconds and look exactly like a flaky server. SSE needs a client of its own with
         * `readTimeout(0)`; it arrives with M6, and this note is here so that lands as a deliberate
         * addition rather than as a fix for a bug nobody could reproduce on a busy account.
         */
